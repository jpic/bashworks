...
# $OSTYPE will be symlinked to the appropriate directory of $os_home_real_prefix.
function os_home_symlink() {
    ...
    for home in $(os_home_get_homedirs); do
        ...
        for dir in $(find $home -type d); do
            ...
            target_dir="$os_home_real_prefix/$relative_target"
        ...
        for file in $(find $home -type f); do
            ...
            target_file="$os_home_real_prefix/$relative_target"
